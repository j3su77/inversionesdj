...
export const AddDocumentUtilityBill = ({ initialData }: ImageFormProps) => {
  ...
  const onSubmit = async (values: FormData) => {
    try {
      await axios.post(`/api/documents/utility-bill`, values);
          ...
          {isUploading ? (
            ...
            <div className="flex flex-col items-center w-full">
              ...
              <IKUpload
                ...
                tags={["utility_bill", `client_${initialData.id}`]}
                validateFile={(file) => {
                  const validTypes = [
                    "image/png",
                    "image/jpeg",
